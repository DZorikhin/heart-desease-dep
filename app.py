...
def main():
    ...
    if st.button('Predict Heart Disease'):
        ...
        if result['risk']:
            st.warning(f"There is a {result['disease_probability']*100:.0f}% probability that the person with provided health parameters has 10-year risk of future coronary heart disease")
        else:
